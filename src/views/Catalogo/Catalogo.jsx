...
const productsData = [
  ...
  },
  {
    ...
    isActive: true,
    price:3350,
    pricePerProduct:"$3.350 / 8 unidades"
  },
  {
    id: 3,
    name: "Tagliatele", 
  ...
  },
  {
    ...
    isActive: true,
    price:2650,
    pricePerProduct:"$2.650 / 8 unidades"
  },
  {
    id: 5,
    name: "Canelones",
    ...
    isActive: true,
    price:3350,
    pricePerProduct:"$3.350 x porcion"
  },
];
const Catalogo = () => {
            ...
            <div className={`${styles.card} ${flippedCards.includes(product.id) ? styles.flipped : ''}`} key={product.id} onClick={() => handleCardClick(product.id)}>
              <div className={styles.cardInner}>
                ...
                <div className={styles.cardBack}>
                  <p className={styles.price}>{product.pricePerProduct}</p>
